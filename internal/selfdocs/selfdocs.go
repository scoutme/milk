...
var (
	...
	aliases = map[string]string{
		...
		"agent remove":         "agents-entry-fields",
		...
		"context window":       "context-window-declaration-context_window_tokens",
		"models.dev":           "context-window-declaration-context_window_tokens",
		"model context window": "context-window-declaration-context_window_tokens",
